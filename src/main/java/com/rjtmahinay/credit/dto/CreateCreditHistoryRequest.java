...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request to create a new credit history record")
public class CreateCreditHistoryRequest {

    @Schema(description = "Social Security Number", example = "123-45-6789", required = true)
    private String ssn;

    @Schema(description = "Account type (CREDIT_CARD, LOAN, MORTGAGE, AUTO_LOAN)", example = "CREDIT_CARD", required = true)
    private String accountType;

    @Schema(description = "Creditor name", example = "Chase Bank", required = true)
    ...
    @Schema(description = "Payment status (CURRENT, LATE_30, LATE_60, LATE_90, CHARGED_OFF, COLLECTIONS)", example = "CURRENT", required = true)
